...
(function ($) {
    $.fn.cityCasCade = function (operation, province, city) {
        ...
        $.fn.cityCascadeParam.loadCity = function (parent) {
            var parent = $(parent);
            var self = document.getElementById(parent.attr("cityId"));
