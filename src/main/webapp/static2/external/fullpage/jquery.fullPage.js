	...
	$.fn.fullpage = function(options) {
		...
		$.fn.fullpage.setAutoScrolling = function(value){
			...
			if(options.autoScrolling){
				...
				//scrolling the page to the section with no fullpage
		...
		* (Because he `scroll` fullpage might get lost with some actions, such as when using continuousVertical)
		*/
		...
		*/
		function createInfiniteSections(v){
			...
			// Recalculate fullpage variables
		...
		*/
		...
		/**
		 * Resizing of the font size depending on the window size as well as some of the imgs on the site.
		 */
		...
		*/
		...
		/**
		* Adds a css3 transform property to the container class with or without fullpage depending on the animated param.
		*/
		...
		*/
		function destroyStructure(){
			...
			//scrolling the page to the top with no fullpage
