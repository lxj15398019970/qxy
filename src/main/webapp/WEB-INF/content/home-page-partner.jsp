...
<div class="contain">
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li
                    class="acur"><a
                    href="${ctx}/home-page!morePartner.action">合作单位</a></li>
    ...
    <div class="content">
        ...
        <!--newsInfo Start-->
        <div class="newsInfo">
            <h1 class="Info_title">${partner.name}</h1>
            <img width="799" border="0" height="600" src="${partner.headImage}" style="width:700px;height:450px;">
