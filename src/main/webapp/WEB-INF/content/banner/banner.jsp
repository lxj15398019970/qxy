...
<div class="page">
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
                <li><a class="toolBar-btn" href="${ctx}/banner/banner!input.action" target="dialog" width="600" height="400" rel="w_agent1">添加</a>
                </li>
                ...
                <li><a class="toolBar-btn" href="${ctx}/banner/banner!input.action?id={sid_user}" target="dialog" width="600" height="400"
                       rel="w_agent1"
                       warn="请选择一个条数据">查看/修改</a></li>
            </ul>
        </div>
        <div layouth="111">
